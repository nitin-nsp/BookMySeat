...
const (
	BookingService_ReserveSeats_FullMethodName   = "/booking.BookingService/ReserveSeats"
	...
	BookingService_ReleaseSeats_FullMethodName   = "/booking.BookingService/ReleaseSeats"
)
...
type BookingServiceClient interface {
	ReserveSeats(ctx context.Context, in *ReserveSeatRequest, opts ...grpc.CallOption) (*ReserveSeatResponse, error)
	...
	ReleaseSeats(ctx context.Context, in *ReleaseSeatRequest, opts ...grpc.CallOption) (*ReleaseSeatResponse, error)
}
...
func (c *bookingServiceClient) ReserveSeats(ctx context.Context, in *ReserveSeatRequest, opts ...grpc.CallOption) (*ReserveSeatResponse, error) {
...
func (c *bookingServiceClient) ReleaseSeats(ctx context.Context, in *ReleaseSeatRequest, opts ...grpc.CallOption) (*ReleaseSeatResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReleaseSeatResponse)
	err := c.cc.Invoke(ctx, BookingService_ReleaseSeats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookingServiceServer interface {
	ReserveSeats(context.Context, *ReserveSeatRequest) (*ReserveSeatResponse, error)
	...
	ReleaseSeats(context.Context, *ReleaseSeatRequest) (*ReleaseSeatResponse, error)
...
func (UnimplementedBookingServiceServer) ReserveSeats(context.Context, *ReserveSeatRequest) (*ReserveSeatResponse, error) {
...
func (UnimplementedBookingServiceServer) ReleaseSeats(context.Context, *ReleaseSeatRequest) (*ReleaseSeatResponse, error) {
...
func _BookingService_ReserveSeats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).ReserveSeats(ctx, req.(*ReserveSeatRequest))
	}
...
func _BookingService_ReleaseSeats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReleaseSeatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookingServiceServer).ReleaseSeats(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_ReleaseSeats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).ReleaseSeats(ctx, req.(*ReleaseSeatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BookingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BookingService_ReleaseSeats_Handler,
		},
	},
